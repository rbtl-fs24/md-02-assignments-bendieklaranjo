...
5.  What are the data types of the three variables used for aesthetic mappings?
    ...
    *continent: non-numerical, categorical variable, lifeExp = numerical discrete variable, fill= non-numerical, categorical variable*
...
-   *Since in the last exercise `count`was set as the `y` variable in the geom_col() function, it does the exact same function as geom_bar(). That is why the plots are identical.*
